...
export const NetworkSelector = () => {
    ...
    value={"base"}
    options={[
      { value: 'sepolia', label: 'Sepolia', prefix: <ChainIcon chain="sepolia"/>},
      { value: 'base', label: 'Base', prefix: <ChainIcon chain="base"/> },
      { value: 'arbitrum', label: 'Arbitrum (coming soon)', prefix:<ChainIcon chain="arbitrum"/>, disabled: true },
      { value: 'optimism', label: 'Optimism (coming soon)', prefix: <ChainIcon chain="optimism"/>, disabled: true },
    ]}
    //@ts-ignore
